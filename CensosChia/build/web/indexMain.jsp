        ...
        <table width="566" height="218" border="1" align="center">
            <tr>
                <td><table width="550" border="0">
                        ...
                        <tr>
                            <td align="center">&nbsp;</td>
                            <td width="250" align="center"><h4><a href="consultaCensosR.jsp"><strong>Consulta de Censos, Pictogr&aacute;ficos e Inventarios</strong></a></h4></td>
                        ...
                        <tr>
                            <td class="center1">&nbsp;</td>
                            <td align="center">Total de Inventarios<span class="colorin"> <%=tam_inv%></span></td>
                            <td align="center"></td>
                        </tr>
                        <tr>
                            <td class="center1">&nbsp;</td>
