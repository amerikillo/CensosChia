        ...
        <div  class="container">
            <div class="row">
                <div class="col-lg-6 text-primary">
                    <h3>Consulta de Jurisdicciones</h3>
                </div>
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <textarea class="form-control" readonly="true" name="campo_1"><%=rset.getString(3)%></textarea>
                            </div>
                        </div>
                    </div>
                    <hr />
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" name="campo_9" readonly="true" ><%=rset.getString(11)%></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <label class="col-sm-2 control-label">Observaciones</label>
                                        <div class="col-lg-10">
                                            <textarea class="form-control" name="campo_14" readonly="true" ><%=rset.getString(16)%></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <label class="col-sm-2 control-label">Observaciones</label>
                                        <div class="col-lg-10">
                                            <textarea class="form-control" name="campo_16" readonly="true" ><%=rset.getString(18)%></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" name="campo_17" readonly="true" ><%=rset.getString(19)%></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
